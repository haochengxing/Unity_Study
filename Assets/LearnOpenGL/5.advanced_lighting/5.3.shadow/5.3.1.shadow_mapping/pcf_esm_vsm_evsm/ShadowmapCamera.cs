...
public class ShadowmapCamera : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (smTex!=null)
        {
            Shader.SetGlobalTexture("smTex",smTex);
        }
        if (esmTex != null)
        {
            Shader.SetGlobalTexture("esmTex", esmTex);
        }
        if (vsmTex != null)
        {
            Shader.SetGlobalTexture("vsmTex", vsmTex);
        }
        ...
        if (buildShadowmaps)
        {
            ...
            cam.RenderWithShader(Shader.Find("Unlit/ShadowmapCaster"),"");
            ...
            var mat = new Material(Shader.Find("Unlit/E-ShadowmapCaster"));
            mat.mainTexture = smTex;
        ...
        {
            lightingShader = Shader.Find("Unlit/esm-DeferredShading");
        }
